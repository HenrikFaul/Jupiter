...
object StructuralHash {
    ...
    // Media thresholds intentionally do not live here anymore: video/PDF/audio are confirmed by
    // MediaFingerprintMatcher's per-type vector + metadata gates, never one shared Hamming bound.
}
