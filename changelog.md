...
- **[remote]** Implementációs commit `4ad95ee0220629a645b17046a6691b3df9623318` közvetlenül
  `origin/main`-re pusholva. [Android CI run 29867228533](https://github.com/HenrikFaul/Jupiter/actions/runs/29867228533)
  **SUCCESS**: Unit tests 4m19s, Build APKs 9m05s; debug/release artifact, időbélyeges archive és
  `build-latest` publikálás sikeres.
- **[release]** Online [app-debug.apk](https://github.com/HenrikFaul/Jupiter/releases/download/build-latest/app-debug.apk):
  **36 503 418 byte**, GitHub asset SHA-256
  `f545e6108bd5e7fd955cd0ffabc2561020a4ac0ebe95eeea58b22f28cc11f635`.
- **[release]** Online [app-release.apk](https://github.com/HenrikFaul/Jupiter/releases/download/build-latest/app-release.apk):
  **7 936 127 byte**, GitHub asset SHA-256
  `38cdf40748333c5c7d123004a9c75bd39ef98b2282b132c50a2736b105cd9eb3`.
- A release látható neve `Jupiscan — latest build (4ad95ee…)`; az egyetlen CI-annotáció az örökölt
  Node.js 20 actionök GitHub által Node.js 24-re kényszerített deprecációs figyelmeztetése, nem hiba.
